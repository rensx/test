...
public :
	...
	DrawArea() : ptr(CDrawArea_create()), own_this(true) {Chart::setLicenseCode("DEVP-2H66-KHXE-7A57-0EE8-4FFB");}
	static DrawArea* create() { return new DrawArea(); }
	DrawArea(DrawAreaInternal *_ptr) : ptr(_ptr), own_this(false) {Chart::setLicenseCode("DEVP-2H66-KHXE-7A57-0EE8-4FFB");}
...
public :
	...
	BaseChart() : ptr(0), refCount(new int), drawAreaCache(0) { *refCount = 1; Chart::setLicenseCode("DEVP-2H66-KHXE-7A57-0EE8-4FFB");
}
	BaseChart(BaseChart *rhs) : ptr(rhs->ptr), refCount(rhs->refCount), drawAreaCache(0) { ++(*refCount);Chart::setLicenseCode("DEVP-2H66-KHXE-7A57-0EE8-4FFB"); }
